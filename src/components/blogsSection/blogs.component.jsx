...
const Blog = ({ selectCount }) => {
    // Use slice to get the first 4 objects
    const selectedBlogs = blogsData.slice(0, selectCount);
    return(
        // blog section
        <section className="blog">
            ...
            <SectionTexts
             ...
             color='black'
            />
            {/* blogs: contains the blog cards */}
            <div className="blogs row">
                {
                    // render all selected blogs
                    selectedBlogs.map(({imgUrl, date, author, title, info, id}, index) => {
                        return <BlogCard
                         key={index}
                         imgUrl={imgUrl}
                         date={date}
